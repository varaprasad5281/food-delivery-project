                            ...
                            <div className="menu-list">
                                ...
                                <div className="res-menu-image">
                                    <div className="res-menu-img">
                                        {item.card.info.imageId && <img src={`https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/${item.card.info.imageId}`} alt="menu-img" className="menu-image" />}
                                    </div>
